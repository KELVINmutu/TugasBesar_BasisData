            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                           <div class="table-responsive table--no-card m-b-30">
                            <form action="dt_keuanganM_sv.php" enctype="multipart/form-data" method="post">
                                <div class="form-group">
                                <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <input type="text" class="form-control" required="" name="jumlah" autocomplete="off">    
                                            ...
                                            <tr>
                                                <td><button type="submit" name="simpan" class="btn btn-primary">Tambah Uang Masuk</button></td>
                        ...
                        <div class="row">
                           <div class="table-responsive table--no-card m-b-30">
                            <form action="dt_karyawanK_sv.php" enctype="multipart/form-data" method="post">
                                <div class="form-group">
                                <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><button type="submit" name="simpan" class="btn btn-primary">Tambah Uang Keluar</button></td>
                        ...
                        <div class="header-desktop">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>Copyright © UMM CODING All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
